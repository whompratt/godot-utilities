...
@export var debug_contents: bool:
	get:
		return false
	set(_new):
...
func serialise() -> Dictionary:
	...
	result[KEY_ITEM_PROTOSET] = protoset.resource_path
...
func deserailise(source: Dictionary) -> bool:
	...
	|| !Verify.dict(source, false, KEY_CONSTRAINTS, TYPE_DICTIONARY):
		...
		protoset = load(source[KEY_ITEM_PROTOSET])
